...
{
   const {openModal, close, action ,nameButton, color, type, title,fullWidth, formRef, onSuccess, onError, userEdit} = props
   const theme = useTheme();
   const fullScreen = useMediaQuery(theme.breakpoints.down('sm'));
   const typeAction = type === 'add' ? 'save' : 'update' ;

   return (
      <Dialog open={openModal} onClose={close} fullScreen={fullScreen} fullWidth maxWidth="sm">
